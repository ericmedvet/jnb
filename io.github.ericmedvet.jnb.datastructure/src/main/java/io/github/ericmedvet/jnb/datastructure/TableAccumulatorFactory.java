...
public class TableAccumulatorFactory<E, V, K> implements AccumulatorFactory<E, Table<Integer, String, V>, K> {
  ...
  private final List<Function<? super K, ? extends V>> kFunctions;

  public TableAccumulatorFactory(
      List<Function<? super E, ? extends V>> eFunctions,
      List<Function<? super K, ? extends V>> kFunctions
  ) {
  ...
  @Override
  public Accumulator<E, Table<Integer, String, V>> build(K r) {
    Map<String, ? extends V> kValues = kFunctions.stream()
